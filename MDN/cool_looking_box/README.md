...
- __Prerequisites__:  Before attempting this assessment you should have already worked through all the articles in this module.
- __Objective__:  To test comprehension of the CSS box model and other box-related features such as borders and backgrounds.
...
__Note__: If you get stuck, then ask us for help — see the [Assessment or further help](https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/A_cool_looking_box#assessment_or_further_help) section at the bottom of this page.
...
![A big red box with rounded corners. White text with drop shadow reads 'this is a cool box'.](imgs/fancy-box2.png)
...
## [Live result](https://goodalex223.github.io/MDN/cool_looking_box/index.html)
