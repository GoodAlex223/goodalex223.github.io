...
__Objective__:  To test comprehension of HTML tables and associated features.
...
![Expected result of table project](table-expected1.png)

## My result

![My result of table project](table-result1.png)

## [Live result](https://goodalex223.github.io/MDN/table/index.html)
