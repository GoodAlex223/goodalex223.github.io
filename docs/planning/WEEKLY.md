...
- [x] Add `pull_request:` trigger to `.github/workflows/deploy.yml`; verify/guard the deploy job against feature-branch deploys *(3 SP)* — PR [#78](https://github.com/GoodAlex223/goodalex223.github.io/pull/78) **merged** `9309015`; PR gate ran green + `deploy` skipped, post-merge deploy green
...
| D. deploy.yml PR Trigger | CI/Build | 🟡 Ops | 1 | 3 | Mon | ✅ Done (PR #78 merged `9309015`) |
